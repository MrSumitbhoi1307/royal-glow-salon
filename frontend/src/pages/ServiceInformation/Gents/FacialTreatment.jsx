...
const services = [
  { name: "Classic Facial", description: "Deep cleansing facial for refreshed, healthy skin.", price: "₹899" },
  { name: "De-Tan Facial", description: "Tan removal facial to restore your natural skin tone.", price: "₹1,199" },
  { name: "Anti-Acne Facial", description: "Targeted treatment to control acne and breakouts.", price: "₹1,499" },
  { name: "Gold Facial", description: "Luxury gold facial for radiant, glowing skin.", price: "₹1,999" },
  { name: "Charcoal Facial", description: "Deep pore-cleansing facial using activated charcoal.", price: "₹1,299" },
];
...
>
  ...
  Back to Services
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">Facial Treatment</h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
          Luxury facial treatments designed to give men healthy, refreshed, and radiant-looking skin.
        </p>
