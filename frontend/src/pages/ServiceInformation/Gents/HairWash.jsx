...
const services = [
  { name: "Classic Hair Wash", description: "Refreshing hair wash using premium shampoo and conditioner.", price: "₹199" },
  { name: "Anti-Dandruff Wash", description: "Medicated wash to control dandruff and scalp irritation.", price: "₹299" },
  { name: "Hair Wash + Head Massage", description: "Relaxing wash combined with a soothing head massage.", price: "₹399" },
  { name: "Herbal Hair Wash", description: "Natural herbal wash for healthy, nourished hair.", price: "₹349" },
];
...
>
  ...
  Back to Services
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">Hair Wash</h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
          Premium hair wash using luxury hair care products for a refreshing, clean, and healthy scalp experience.
        </p>
