...
const services = [
  { name: "Deep Tissue Massage", description: "Intense massage to relieve deep muscle tension.", price: "₹1,499" },
  { name: "Swedish Massage", description: "Relaxing full-body massage to relieve stress.", price: "₹1,299" },
  { name: "Foot Reflexology", description: "Pressure-point foot massage for total relaxation.", price: "₹899" },
  { name: "Aromatherapy Massage", description: "Therapeutic massage using essential aromatic oils.", price: "₹1,699" },
  { name: "Body Scrub & Polish", description: "Exfoliating body treatment for smooth, refreshed skin.", price: "₹1,999" },
];

const SpaMassageGents = () => {
  return (
...
>
  ...
  Back to Services
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
          Premium spa therapies designed for ultimate relaxation, stress relief, and complete wellness.
        </p>
...
export default SpaMassageGents;