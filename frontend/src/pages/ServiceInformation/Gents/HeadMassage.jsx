...
const services = [
  { name: "Classic Head Massage", description: "Relaxing head massage to relieve stress and tension.", price: "₹299" },
  { name: "Aromatic Oil Massage", description: "Head massage using premium aromatic oils.", price: "₹449" },
  { name: "Champi Massage", description: "Traditional Indian head massage for deep relaxation.", price: "₹349" },
  { name: "Hair Fall Control Massage", description: "Therapeutic massage using hair-fall control serums.", price: "₹599" },
];
...
>
  ...
  Back to Services
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">Head Massage</h1>
