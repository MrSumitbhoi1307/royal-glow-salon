...
const services = [
  { name: "Bridal Makeup (HD)", description: "Flawless HD makeup for your wedding day with premium products.", price: "₹8,999" },
  { name: "Bridal Trial Session", description: "Pre-wedding makeup trial to finalize your perfect bridal look.", price: "₹2,499" },
  { name: "Engagement Makeup", description: "Elegant makeup look for your engagement ceremony.", price: "₹4,999" },
  { name: "Reception Makeup", description: "Glamorous makeup for your reception party.", price: "₹5,999" },
  { name: "Family Function Makeup", description: "Party-ready makeup for family members and guests.", price: "₹1,999" },
];
...
>
  ...
  Back to Services
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">Bridal Makeup</h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
          Exclusive bridal makeover packages designed to make your special day unforgettable, using premium international makeup brands.
        </p>
